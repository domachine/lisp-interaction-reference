...
%\usepackage{shortvrb}  % \MakeShortVerb{\#} \DeleteShortVerb{\#}
...
%\usepackage[style=authoryear,  % Autor und Jahr, z. B. in Physik
            %hyperref=true,true % verlinke Bibliographie
            %firstinits=true,   % Vorname zu Initialen kürzen
            %isbn=false,        % keine ISBN in Bibliographie übernehmen
            %]{biblatex}
%\bibliography{Bibfile}       % Gibt den Ort der Bibliographiedatei an
